...
new Vue({
    ...
    methods: {
        loadRouteAssets(path) {
            ...
            // Conditionally load assets based on route
            if (path === '/admin/event/add') {
                ...
                // this.loadJs('/notika/js/flot/flot-active.j');
        ...
        loadCssJs_dashboard(){
            ...
            this.loadCss('/notika/css/style.css');
            ...
            this.loadJs('/notika/js/wave/waves-active.js');
