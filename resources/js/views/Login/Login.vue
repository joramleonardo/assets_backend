                        ...
                        <div class="screen__content">
                            <div class="login" id="loginForm">
                                ...
                                <div class="login__field">
                                    ...
                                    <input type="text" class="login__input" placeholder="Username" v-model="user.username">
                                </div>
                                <div class="login__field">
                                    <i class="login__icon fas fa-lock"></i>
                                    <input type="password" class="login__input" placeholder="Password" v-model="user.password">
                                </div>
                                <button class="button login__submit"  @click="loginUser()">
