                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        >
                                            ...
                                            <template #cell(photo_fileName)="row">
                                                <img class="img-fluid img-thumbnail" :src='`/storage/images/${row.value}`' alt="..." style="max-width: 15%;"/>   
                                            </template>
        ...
        export default {
            data() {
                return {
                    ...
                    fields_draft: [
                        ...
                        { key: 'photo_fileName', label: 'Photo Preview'},
                        { key: 'photo_title', label: 'Title'},
                        { key: 'photo_description', label: 'Description'},
                        { key: 'photo_category', label: 'Category'},
                        { key: 'photo_photographer', label: 'Photographer'},
                        { key: 'photo_tags', label: 'Tags'},
            ...
            methods: {
                loadDraftList: async function() {
                    ...
                    try{
                        const response = await assets_service.getAllListPhoto();
